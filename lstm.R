#' Code from https://www.business-science.io/timeseries-analysis/2018/04/18/keras-lstm-sunspots-time-series-prediction.html
#' on how to set up a LSTM model for time series *FORECASTING*
